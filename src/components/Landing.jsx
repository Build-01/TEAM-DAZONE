...
const Landing = () => {
  ...
  const getButtonStyle = (role) => ({
    ...
    backgroundColor: selectedRole === role ? 'var(--primary-green)' : '#F7fbfa',
    color: selectedRole === role ? '#F7fbfa' : 'var(--text-dark)',
  });
  ...
  return (
    <div className="main-container">
      <div className="content-area">
        ...
        <div style={{ height: '220px', backgroundColor: '#F7fbfa', margin: '30px 0', borderRadius: '20px' }}></div>
        <div>
